describe('09 - Branching Logic', {
    ...
    () => {
        ...
        describe('User Interface', () => {
            it('9-1/5: Should have the ability to show a field ONLY when specific conditions are met', () => {
                ...
                function dAndDItem(index) {
                    ...
                    // TODO: Various recommended methods for drag-n-drop in cypress no-workie. The plugin works tho.
